...
function Mobile_App() {
  ...
  return (
    <section
      className="bg-gradient-mobile py-16 md:py-24 relative overflow-hidden"
      id="mobileapp"
    >
      {/* Background Effects */}
          ...
          <div className="md:w-1/2">
            <ScrollReveal direction="left">
              ...
              <h2 className="font-extrabold text-white mb-3 text-2xl md:text-4xl leading-tight">
                Take Flexi CRM <span className="text-accent">Everywhere</span> You
                Go
              </h2>
              <p className="text-base text-white/65 mb-6 max-w-md leading-relaxed">
                Manage your leads, track follow-ups, and stay on top of your pipeline
              ...
              {/* App Store Buttons - Professional UI */}
              <div className="flex flex-col sm:flex-row gap-4 mb-4">
                <motion.a
                  href="#"
                  whileHover={{ scale: 1.02, y: -2 }}
                  whileTap={{ scale: 0.98 }}
                  className="group relative overflow-hidden rounded-xl bg-black/40 backdrop-blur-sm border border-white/20 transition-all duration-300 hover:border-accent/50 hover:shadow-lg hover:shadow-accent/10"
                >
                  <div className="flex items-center gap-3 px-5 py-3">
                    ...
                    <div className="text-white">
                      ...
                      >
                        <path
                          d="M18.71 19.5C17.88 20.74 17 21.95 15.66 21.97C14.32 22 13.89 21.18 12.37 21.18C10.85 21.18 10.37 21.95 9.17 22C7.97 22.05 7 20.75 6.17 19.5C4.47 16.97 3.27 12.07 5.04 8.81C5.92 7.22 7.56 6.12 9.31 6.07C10.56 6.02 11.75 6.9 12.56 6.9C13.37 6.9 14.82 5.85 16.32 6.02C17.08 6.06 18.83 6.34 19.94 7.86C19.83 7.93 17.68 9.1 17.71 11.78C17.74 14.98 20.44 16.03 20.5 16.06C20.46 16.17 19.97 17.66 18.71 19.5Z"
                          fill="currentColor"
                        />
                        <path
                          d="M15.45 4.13C16.14 3.26 16.62 2.03 16.45 0.75C15.42 0.83 14.19 1.5 13.48 2.37C12.85 3.14 12.33 4.37 12.52 5.61C13.6 5.73 14.76 5.01 15.45 4.13Z"
                          fill="currentColor"
                        />
                      </svg>
                    </div>
                  ...
                  <div className="absolute inset-0 -z-10 bg-gradient-to-r from-accent/0 via-accent/10 to-accent/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                </motion.a>
                ...
                >
                  <div className="flex items-center gap-3 px-5 py-3">
                    ...
                    <div className="text-white">
                      ...
                      >
                        <path
                          d="M3.609 1.814L13.792 12L3.609 22.186C3.262 21.977 3 21.589 3 21.142V2.858C3 2.411 3.262 2.023 3.609 1.814Z"
                          fill="currentColor"
                        />
                        <path
                          d="M4.74 23.5L15.52 12.72L18.28 15.48L4.74 23.5Z"
                          fill="currentColor"
                        />
                        <path
                          d="M18.28 8.52L15.52 11.28L4.74 0.5L18.28 8.52Z"
                          fill="currentColor"
                        />
                        <path
                          d="M21 7.5L18.5 9L15.5 6L18.5 3L21 4.5C21.6 4.8 22 5.4 22 6C22 6.6 21.6 7.2 21 7.5Z"
                          fill="currentColor"
                        />
                        <path
                          d="M21 16.5L18.5 15L15.5 18L18.5 21L21 19.5C21.6 19.2 22 18.6 22 18C22 17.4 21.6 16.8 21 16.5Z"
                          fill="currentColor"
                        />
                      </svg>
                    </div>
                ...
                <div className="absolute inset-0 p-3 pt-10 flex flex-col gap-1">
                  ...
                  <div className="grid grid-cols-2 gap-1">
                    {[
                      ...
                      <div
                        key={i}
                        className="bg-white/10 rounded-lg p-1.5 border border-white/10"
                      >
                        <h4
                          className="font-sora font-extrabold text-sm"
                          style={{ color: m.color }}
                        >
                          {m.val}
                        </h4>
                  ...
                  <p className="text-[10px] text-white/50 font-semibold px-1">
                    Recent Leads
                  </p>
                  {[
                    {
                    ...
                    <div
                      key={idx}
                      className="flex items-center gap-2 bg-white/10 rounded p-1.5"
                    >
                      <div
                      ...
                      <div
                        ...
                        style={{ backgroundColor: lead.dot }}
                      />
                    </div>
                  ))}
                </div>
              ...
              <div className="h-full bg-gradient-to-b from-[#0d1a2e] to-[#0f2540]">
                ...
                <div className="absolute inset-0 p-3 pt-10 flex flex-col gap-1">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="px-1.5 py-0.5 bg-accent text-white text-[9px] font-bold rounded">
                      3 New
                    </span>
                  </div>
                  {[
                    {
                      title: "🔔 Follow-up Due",
                      name: "Ravi Shankar",
                      sub: "TechVision • 10:30 AM",
                      color: "#F5921E",
                      bg: "rgba(245,146,30,0.1)",
                      border: "rgba(245,146,30,0.2)",
                    },
                    {
                      title: "✅ Lead Converted",
                      name: "Priya Nair",
                      sub: "Closed ₹2.4L deal",
                      color: "#4ade80",
                    ...
                    },
                    {
                      ...
                      name: "Karan Mehta",
                      sub: "Added by Sneha • 9:15 AM",
                      color: "#60a5fa",
                      bg: "rgba(30,95,168,0.15)",
                      border: "rgba(30,95,168,0.25)",
                    },
                  ].map((it, idx) => (
                    <div
                      key={idx}
