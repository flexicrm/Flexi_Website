...
function Demo() {
  ...
  return (
    <div
      ref={heroRef}
      id="home"
      className="min-h-screen pt-24 sm:pt-32 pb-16 sm:pb-24 bg-gradient-hero relative overflow-hidden"
    >
              ...
              <motion.div variants={heroItem}>
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 justify-center lg:justify-start">
                  <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.95 }}>
                    <a
                      href="/register"
                      className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-[#3395ff] text-white font-bold rounded-xl shadow-lg hover:bg-blue-700 transition-all text-sm sm:text-base w-full sm:w-auto"
                    >
                  ...
                  <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.95 }}>
                    <button className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-[#3395ff] text-[#3395ff] font-bold rounded-xl hover:bg-primary/5 transition-all cursor-pointer text-sm sm:text-base w-full sm:w-auto">
                      ▶ View Demo
                    </button>
                  </motion.div>
                </div>
              ...
              <div className="grid grid-cols-3 gap-2 mb-4">
                {[
                  ...
                  <motion.div
                    ...
                    className="bg-gray-100 rounded-lg p-1.5 sm:p-2 text-center"
                  >
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] sm:text-xs text-gray-500 truncate">{lead.company}</p>
                    </div>
      ...
      <div className="md:hidden mt-8 px-4">
        <div className="bg-white rounded-xl shadow-xl p-4 border border-gray-200">
          ...
          <div className="grid grid-cols-3 gap-2 mb-3">
            {[
              ...
              <div key={idx} className="bg-gray-100 rounded-lg p-2 text-center">
                <h4 className="font-sora font-extrabold" style={{ color: m.color }}>{m.value}</h4>
          ...
          <div className="flex flex-col gap-2">
            {[
              { name: "Arun Kumar", company: "TechCorp Pvt Ltd", status: "🔥 Hot" },
              ...
              <div key={idx} className="flex items-center gap-2 p-2 bg-gray-100 rounded-lg">
                ...
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-gray-200">{lead.status}</span>
              </div>
            ))}
          </div>
        </div>
